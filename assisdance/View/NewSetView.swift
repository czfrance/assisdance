...
struct NewSetView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            VStack {
                ...
                Button {
                    createNewSet(name: setname, numDancers: dancers, width: geometry.size.width, height: geometry.size.height)
    ...
    func createNewSet(name: String, numDancers: Int, width: Double, height: Double) {
...
//        formationBook.addSet(newSet)
        var _ = formationBook.createNewSet(name: name, numDancers: numDancers, width: width, height: height)
